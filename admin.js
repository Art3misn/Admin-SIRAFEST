...
// Event: Klik hamburger (mobile toggle)
if (mobileToggle) {
...
// Event: Klik di luar sidebar (global)
document.addEventListener('click', function(e) {
    if (sidebar && sidebar.classList.contains('active')) {
        const isSidebar = sidebar.contains(e.target);
        const isToggle = mobileToggle ? mobileToggle.contains(e.target) : false;
...
// Event: Resize window (auto close saat desktop)
